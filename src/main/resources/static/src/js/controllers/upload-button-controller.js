(function (window, angular, $) {
    ...
    angular
        ...
        .controller('ButtonController', ['Importer', ButtonController]);

    //ButtonController.$inject = ['Importer'];

    function ButtonController($scope, Importer) {
        $scope.upload = null;
        $scope.fileUuid = null;
        $scope.flow = null;
        ...
        $scope.insertItems = function(f) {
            f.upload();
        };

        $scope.submitForm = function() {
            $http.post('/importer', { "user_data": $scope.flow });
        };
        ...
        /*
         * Remove the Importer so we can go it again.
         */
