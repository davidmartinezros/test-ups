package gov.max.service.file.service.upload;
...
public class FlowInfoStorage {
     ...
     * @return FlowInfo
     */
    public FlowInfo get(int flowChunkSize, long flowTotalSize, String flowIdentifier, String flowFilename, String flowRelativePath, String flowFilePath) {
    ...
    public void remove(FlowInfo info) {
        flowInfoMap.remove(info.flowIdentifier);
    }
}